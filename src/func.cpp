...
namespace gravity{
    ...
    pair<func<double>,func<double>> get_real_imag(const func<Cpx>& f){
        ...
        for (auto &qt: *f._qterms) {
            ...
            if(qt.second._sign){
                f_r += c_r*(p1_r*p2_r - p1_i*p2_i) - c_i*(p1_r*p2_i + p1_i*p2_r);
                f_i += c_r*(p1_r*p2_i + p1_i*p2_r) + c_i*(p1_r*p2_r - p1_i*p2_i);
            }
            else {
                f_r -= c_r*(p1_r*p2_r - p1_i*p2_i) - c_i*(p1_r*p2_i + p1_i*p2_r);
                f_i -= c_r*(p1_r*p2_i + p1_i*p2_r) + c_i*(p1_r*p2_r - p1_i*p2_i);
        ...
        for (auto &lt: *f._lterms) {
            ...
            if(lt.second._sign){
                f_r += c_r*p1_r - c_i*p1_i;
                f_i += c_r*p1_i + c_i*p1_r;
            }
            else {
                f_r -= c_r*p1_r - c_i*p1_i;
                f_i -= c_r*p1_i + c_i*p1_r;
