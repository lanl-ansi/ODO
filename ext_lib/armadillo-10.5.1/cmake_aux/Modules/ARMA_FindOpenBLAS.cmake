...
foreach (OpenBLAS_NAME ${OpenBLAS_NAMES})
  find_library(${OpenBLAS_NAME}_LIBRARY
    ...
    PATHS ${CMAKE_SYSTEM_LIBRARY_PATH} ${PROJECT_SOURCE_DIR}/.. /lib64 /lib /usr/lib64 /usr/lib /usr/local/lib64 /usr/local/lib /opt/local/lib64 /opt/local/lib /usr/lib/openblas/ /usr/lib/openblas/lib /usr/local/opt/openblas/lib /opt/local/lib/openblas /opt/local/lib/openblas/lib
    )
